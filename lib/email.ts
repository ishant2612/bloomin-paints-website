...
// console.log('[v0] email.ts loaded')
...
//   pincode: string
// }
// console.log("sendOrderConfirmationEmail entered");
// export async function sendOrderConfirmationEmail(data: OrderEmailData) {
//   console.log('[v0] Preparing to send order confirmation email to', data.customerEmail)
//   try {
//     const response = await resend.emails.send({
//       from:'Bloomin Paints <onboarding@resend.dev>',
...
console.log('[EMAIL] email.ts loaded')
...
export async function sendOrderConfirmationEmail(data: OrderEmailData) {
  console.log('[EMAIL] ===============================')
  console.log('[EMAIL] sendOrderConfirmationEmail() called')
  console.log('[EMAIL] Sending to:', data.customerEmail)
...
.header {
  background: linear-gradient(135deg,#e9439c,#ff80cc);
  color: white;
  padding: 30px;
  text-align: center;
}
...
<p><strong>Artwork:</strong> ${data.paintingTitle}</p>
...
<p>
We'll contact you shortly regarding payment and shipping.
</p>
...
`,
    ...
    console.error('[EMAIL] EXCEPTION OCCURRED')
    console.error(err)
    return false
  }
}